...
snippet::io.micronaut.jms.docs.configuration.ActiveMQXAConnectionBeanFactory[tags="imports,clazz", project-base="docs-examples/example"]

and, then, create a JMSConnectionPool in another factory:

snippet::io.micronaut.jms.docs.configuration.JmsConnectionPoolActiveMQXAConnectionFactory[tags="imports,clazz", project-base="docs-examples/example"]
